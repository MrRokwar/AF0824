...
public class RentalStoreTest {
    ...
    public void setupRentalAgreementTest(){
        ...
        try {
            ...
            assertEquals(LocalDate.of(2015, 9, 4),resultAgreement.getDueDate());
    ...
    public void setupRentalAgreementZeroChargeDaysTest(){
        ...
        try {
            resultAgreement = RentalStore.setupRentalAgreement("CHNS", 2, 0, LocalDate.of(2024,8,2));
            ...
            assertEquals(LocalDate.of(2024, 8, 2),resultAgreement.getCheckoutDate());
    ...
    public void setupRentalAgreementWeekend4thOfJulyTest(){
        ...
        try{
            resultAgreement = RentalStore.setupRentalAgreement("LADW", 1, 10, LocalDate.of(2020,7,2));
            assertEquals(0,resultAgreement.getChargeDays());
        } catch (InvalidRentalAgreementException e){
            fail(e);
        }
        ...
        try{
            resultAgreement = RentalStore.setupRentalAgreement("LADW", 1, 10, LocalDate.of(2021,7,4));
            assertEquals(0,resultAgreement.getChargeDays());
        } catch (InvalidRentalAgreementException e){
            fail(e);
        }
    ...
    public void test2(){
        ...
        String expectedAgreement = "toolCode: 'LADW', toolType: 'Ladder', toolBrand: 'Werner', rentalDays: 3, checkoutDate: 07/02/20, dueDate: 07/05/20, dailyCharge: $1.99, chargeDays: 2, preDiscountCharge: $3.98, discountPercent: 10%, discountAmount: $0.40, finalCharge: $3.58";
    ...
    public void test3(){
        ...
        String expectedAgreement = "toolCode: 'CHNS', toolType: 'Chainsaw', toolBrand: 'Stihl', rentalDays: 5, checkoutDate: 07/02/15, dueDate: 07/07/15, dailyCharge: $1.49, chargeDays: 3, preDiscountCharge: $4.47, discountPercent: 25%, discountAmount: $1.12, finalCharge: $3.35";
        assertEquals(expectedAgreement, resultAgreement.formattedOutput());
    }
    ...
    public void test4(){
        ...
        String expectedAgreement = "toolCode: 'JAKD', toolType: 'Jackhammer', toolBrand: 'DeWalt', rentalDays: 6, checkoutDate: 09/03/15, dueDate: 09/09/15, dailyCharge: $2.99, chargeDays: 3, preDiscountCharge: $8.97, discountPercent: 0%, discountAmount: $0.00, finalCharge: $8.97";
        assertEquals(expectedAgreement, resultAgreement.formattedOutput());
    }
    ...
    public void test5(){
        ...
        String expectedAgreement = "toolCode: 'JAKR', toolType: 'Jackhammer', toolBrand: 'Ridgid', rentalDays: 9, checkoutDate: 07/02/15, dueDate: 07/11/15, dailyCharge: $2.99, chargeDays: 5, preDiscountCharge: $14.95, discountPercent: 0%, discountAmount: $0.00, finalCharge: $14.95";
        assertEquals(expectedAgreement, resultAgreement.formattedOutput());
    }
    ...
    public void test6(){
        ...
        String expectedAgreement = "toolCode: 'JAKR', toolType: 'Jackhammer', toolBrand: 'Ridgid', rentalDays: 4, checkoutDate: 07/02/20, dueDate: 07/06/20, dailyCharge: $2.99, chargeDays: 1, preDiscountCharge: $2.99, discountPercent: 50%, discountAmount: $1.50, finalCharge: $1.50";
        assertEquals(expectedAgreement, resultAgreement.formattedOutput());
    }
}
